        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-600 mb-4">
              Advanced investment intelligence for modern investors.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#features" className="text-gray-600 hover:text-brand-purple transition-colors">Features</a></li>
              <li><a href="#how-it-works" className="text-gray-600 hover:text-brand-purple transition-colors">How It Works</a></li>
              <li><a href="#testimonials" className="text-gray-600 hover:text-brand-purple transition-colors">Testimonials</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-brand-purple transition-colors">Help Center</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="text-gray-600 hover:text-brand-purple transition-colors">Cookie Policy</a></li>
            </ul>
          </div>
        </div>
