  ...
  return (
    <section className="relative pt-24 md:pt-32 pb-16 md:pb-24 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute -top-[30%] -left-[10%] w-[70%] h-[70%] rounded-full bg-gradient-to-br from-brand-lightAccent/20 to-transparent"></div>
        <div className="absolute top-[60%] -right-[5%] w-[40%] h-[40%] rounded-full bg-gradient-to-bl from-brand-lightAccent/20 to-transparent"></div>
      </div>
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex flex-col md:flex-row items-center space-y-12 md:space-y-0">
          ...
          <div className="w-full md:w-1/2 space-y-6 reveal">
            <p className="inline-block bg-brand-accent/10 text-brand-accent px-4 py-1 rounded-full font-medium text-sm">
              Coming Soon
            </p>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-2">
              ...
              <Button variant="outline" size="lg" className="border-brand-accent text-brand-accent hover:bg-brand-accent/10">
                Join Waitlist
              </Button>
            </div>
